...
const Textarea = forwardRef<HTMLTextAreaElement, ComponentProps<'textarea'>>(
	({ className, ...props }, reference) => {
		return (
			<textarea
				className={cn(
					'placeholder:text-muted-foreground focus-visible:ring-ring bg-background-highContrast flex min-h-[60px] w-full rounded-md px-4 py-2 text-xl focus-visible:outline-none focus-visible:ring-1 disabled:cursor-not-allowed disabled:opacity-50',
					className,
				)}
				ref={reference}
				{...props}
